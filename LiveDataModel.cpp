...
LiveDataModel::LiveDataModel(QObject *parent)
  ...
  , _lds()
  , _shortNameHeader(RSystemDB::queryText("ShortName"))
  , _contentHeader(RSystemDB::queryText("Content"))
  , _valueHeader(RSystemDB::queryText("Value"))
  , _unitHeader(RSystemDB::queryText("Unit"))
  , _dftValueHeader(RSystemDB::queryText("Default Value"))
{
...
void LiveDataModel::update(const RLiveDataList::Elements &lds)
{
  clear();
  _lds = lds;
